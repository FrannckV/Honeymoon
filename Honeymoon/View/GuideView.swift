        ...
        ScrollView(.vertical, showsIndicators: true) {
            VStack(alignment: .center, spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 25) {
                    ...
                    GuideComponent(title: "Book", subtitle: "Tap the button", description: "Our selection of honeymoon resorts is the perfect setting for you to embark your life together.", icon: "checkmark.square")
                }
